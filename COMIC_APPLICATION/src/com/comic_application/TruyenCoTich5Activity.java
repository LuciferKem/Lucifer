...
public class TruyenCoTich5Activity extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_truyen_co_tich_5);
    ...
    private void parseXML()
    {
        ...
        try {
            ...
            InputStream is = assetManager.open("trikhoncuataday.xml");
