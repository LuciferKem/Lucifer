...
public class TruyenCoTich4Activity extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_truyen_co_tich_4);
    ...
    private void parseXML()
    {
        ...
        try {
            ...
            InputStream is = assetManager.open("sungvachanhuou.xml");
