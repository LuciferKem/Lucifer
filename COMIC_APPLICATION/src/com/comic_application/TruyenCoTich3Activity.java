...
public class TruyenCoTich3Activity extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_truyen_co_tich_3);
    ...
    private void parseXML()
    {
        ...
        try {
            ...
            InputStream is = assetManager.open("basoitocvangcuaconquy.xml");
